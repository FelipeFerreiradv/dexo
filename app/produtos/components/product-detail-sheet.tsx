            ...
            <div className="relative isolate overflow-hidden border-b border-border/60 bg-gradient-to-r from-primary/12 via-primary/6 to-transparent pl-6 pr-12 pb-6 pt-6">
              ...
              <div className="relative z-10 flex flex-wrap items-start justify-between gap-4">
                ...
                <div className="flex flex-col items-end gap-1 text-right">
                  ...
                  <p className="text-3xl leading-tight tabular-nums text-foreground [font-family:var(--font-fraunces)]">
                    {formatCurrency(Number(merged.price))}
                  </p>
                  {merged.costPrice !== undefined &&
                ...
                <section className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4">
                    <InfoCard
                      ...
                      label="Altura"
                      value={
                        merged.heightCm ? `${merged.heightCm} cm` : undefined
                      }
                    />
                    <InfoCard
                      icon={<Ruler className="size-4" />}
                      label="Largura"
                      value={
                        merged.widthCm ? `${merged.widthCm} cm` : undefined
                      }
                    />
                    <InfoCard
                      icon={<Ruler className="size-4" />}
                      label="Comprimento"
                      value={
                        merged.lengthCm ? `${merged.lengthCm} cm` : undefined
                      }
                    />
                    <InfoCard
