...
export default async function FiscalConfigPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Multi-CNPJ: com 1 empresa e sem a flag, o manager renderiza APENAS o
          FiscalConfigForm legado — página idêntica à anterior. */}
      <FiscalCompaniesManager productionUnlocked={productionUnlocked} />
    </div>
  );
}
