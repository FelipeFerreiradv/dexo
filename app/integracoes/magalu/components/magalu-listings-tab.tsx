...
import { MagaluListingsSkeleton } from "./magalu-skeleton";
...
export function MagaluListingsTab() {
  ...
  const fetchListings = useCallback(
    async (showRefreshState = false) => {
      ...
      try {
        const url = new URL(`${getApiBaseUrl()}/marketplace/magalu/listings`);
      ...
      <CardHeader>
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <CardDescription>
              Produtos do seu estoque vinculados a anúncios da Magalu
            </CardDescription>
          </div>
        ...
        {listings.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="mt-2 max-w-sm text-sm text-muted-foreground">
              Seus anúncios da Magalu ainda não estão vinculados aos produtos do
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>SKU Magalu</TableHead>
                        ...
                        if (!linkState.isOpenable) {
                          return (
                            ...
                            >
                              ...
                              <span className="sr-only">Anúncio indisponível</span>
                            </Button>
                          );
                        }
                        ...
                        return (
                          <Button variant="ghost" size="sm" asChild>
                            ...
                            >
                              ...
                              <span className="sr-only">Ver na Magalu</span>
                            </a>
                          </Button>
                        );
                      })()}
