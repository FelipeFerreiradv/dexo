...
import { OlxListingsSkeleton } from "./olx-skeleton";
...
export function OlxListingsTab() {
  ...
  const fetchListings = useCallback(
    async (showRefreshState = false) => {
      ...
      try {
        const url = new URL(`${getApiBaseUrl()}/marketplace/olx/listings`);
      ...
      <CardHeader>
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <CardDescription>
              Produtos do seu estoque vinculados a anúncios da OLX
            </CardDescription>
          </div>
                        ...
                        return (
                          <Button variant="ghost" size="sm" asChild>
                            ...
                            >
                              ...
                              <span className="sr-only">Ver na OLX</span>
                            </a>
                          </Button>
                        );
                      })()}
